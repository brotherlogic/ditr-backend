...
public class MongoBridge implements LocalInformation {
    ...
    public User getUser(String foursquareID) {
        ...
        if (response != null)
            return new User(foursquareID, (String) response.get("name"), new State((String) response.get("vid")), (Long) response.get("timestamp"), (String) response.get("token"));
        else
            return null;
    ...
    public User getUserFromToken(String token) {
        ...
        if (response != null)
            return new User((String) response.get("id"), (String) response.get("name"), new State((String) response.get("vid"), (Long) response.get("timestamp")), (Long) response.get("timestamp"),
                    token);
        else
            return null;
    }
